...
from functional_process.boundary import GUESSED, boundary
...
def answers_for(input_file: str) -> tuple[Answer, ...]:
    ...
    """
    from functional_process.cold_start import _resolve, cold_state  # noqa: PLC0415
...
if __name__ == "__main__":
    ...
    from functional_process.provider import _main as main
