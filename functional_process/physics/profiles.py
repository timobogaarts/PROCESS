"""Pure physics functions extracted from `models/physics/profiles.py`.

See that file for the declarations wiring these into the graph, and
`_audit/units/models/physics/profiles.md` for the audit record. No
graph-framework import belongs in this module -- see `_audit/formulas_split.md`.
"""

import jax.numpy as jnp

from functional_process.physics.plasma_profiles import _beta, _simpson
