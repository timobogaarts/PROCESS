...
still holds -- the import path is `functional_process.cottax.models.pfcoil`, the same as a flat
...
- `.pf_coil.m_pf_coil_conductor_total` and `.pf_coil.m_pf_coil_structure_total`
  (read by `functional_process/cottax/models/structure.py::Structure`), and
- `.pf_coil.r_pf_coil_outer` (read by `functional_process/cottax/models/cryostat.py::Cryostat`).
