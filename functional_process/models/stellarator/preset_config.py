...
`functional_process.cottax.models.stellarator.preset_config`, per `_audit/formulas_split.md`
...
from functional_process.vocabulary import HELIAS3, HELIAS4, HELIAS5B, W7X30, W7X50
