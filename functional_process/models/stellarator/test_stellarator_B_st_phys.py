...
not delegated to another model). See `stellarator_B_st_phys.py`'s module docstring for
...
`stellarator_D_structure.py`'s `calculate_intercoil_mass_scaling_reference` was in).
