"""Assembly-level tests for `functional_process.cottax.sand` and `VmconDriver`.
...
def test_default_drivers_reads_the_split_off_the_problem_node():
    ...
    from functional_process.cottax.mda import cut_graph, default_drivers
    from functional_process.cottax.mda_harness import _without_excluded
...
from functional_process.cottax.indat import GRAPH
from functional_process.cottax.sand import constraint_nodes
...
def test_vmcon_driver_traces_under_one_whole_schedule_jit():
    ...
    """
    import functional_process.cottax.sand_harness as harness
...
def test_outcome_sink_is_gone():
    ...
    """
    import functional_process.cottax.core.solver.drivers as drivers_module
...
def test_switch_values_for_reads_the_active_surface_only():
    ...
    """
    from functional_process.cottax.sand import switch_values_for
    from process.core.model import DataStructure
...
def test_the_pf_ring_is_detected_as_an_array_unknown_problem():
    ...
    from functional_process.cottax.mda import cut_graph
    from functional_process.cottax.mda_harness import _without_excluded
    from functional_process.cottax.sand import array_valued_problems
...
def test_boundary_seeds_agree_with_guess_sources():
    ...
    from functional_process.cottax.sand_harness import mda_schedule
