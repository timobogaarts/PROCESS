"""Assembly-level tests for `functional_process.cottax.mdf`, plus one end-to-end cold run.
...
def test_the_in_graph_root_find_gives_the_same_answer(name):
    ...
    """
    from functional_process.cottax.indat import (  # noqa: PLC0415 -- module import is ~20 s
        graph_for,
        machine_from_indat,
        switch_values_from_indat,
    )
    from functional_process.cottax.sand_harness import (  # noqa: PLC0415
        reference_run,
        schedule_verdict,
    )
