...
is compared to what* (the contract's declaration) and trusts the points, so keeping them in
...
def load(module: str, name: str):
    ...
    """
    from functional_process.tests._harness.sampling import Sample  # noqa: PLC0415
