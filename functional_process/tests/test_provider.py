...
from functional_process.cottax.provider import (
    COMPUTED,
    DEFAULT,
    DEFAULTS,
    DERIVED,
...
# =============================================== the native state (`functional_process/cottax/native.py`)
#
...
def test_the_vendored_defaults_are_process_s_own():
    ...
    from functional_process.cottax.native import DATACLASS_DEFAULTS, _expand
...
def test_the_defaults_table_holds_no_place_process_does_not_have():
    ...
    from functional_process.cottax.native import DATACLASS_DEFAULTS
...
def test_the_file_s_own_values_win_over_the_defaults_and_say_so():
    ...
    """
    from functional_process.cottax.native import native_state
...
def test_an_indexed_array_assignment_fills_its_default_rather_than_replacing_it():
    ...
    from functional_process.cottax.native import DATACLASS_DEFAULTS, native_state
...
def test_the_pedestal_raises_one_lower_bound_and_only_where_it_fires():
    ...
    """
    from functional_process.cottax.native import native_reference, native_state
