...
from functional_process.cottax import boundary as fp_boundary
from functional_process.cottax.boundary import orphaned_by
...
from functional_process.cottax.total_process import TokamakProcess
...
TOKAMAK_MACHINE = machine_from_indat(
    str(
        Path(fp_boundary.__file__).resolve().parent.parent.parent
...
Generated -- `FP_WRITE_SWAP_PIN=1 $PY -m pytest functional_process/tests/test_machine.py
