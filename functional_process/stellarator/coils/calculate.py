...
`functional_process.models.stellarator.coils.calculate`, per `_audit/formulas_split.md`
...
from functional_process.stellarator.coils.coils import bmax_from_awp, intersect
from functional_process.stellarator.coils.forces import (
...
from functional_process.stellarator.coils.mass import calculate_coils_mass
from functional_process.stellarator.coils.quench import calculate_quench_protection
...
def winding_pack_total_size(
    ...
    see the record's data-footprint table and JAX-difficulty flags; a single graph
    ...
    **Internally split around `intersect`, this pass** (`_audit/next_steps.md` §7, see
    ...
    computation is organised internally, so that a declared graph can also assemble the
