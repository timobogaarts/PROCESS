"""**Assemble once, solve many times** -- the entry point for the interactive regime.
    ...
    $PY -m functional_process.session --input a.IN.DAT --repeat 8
    $PY -m functional_process.session --repeat 8 --arm sand
...
from functional_process import native  # noqa: E402
from functional_process import sand as sand_module  # noqa: E402
...
from functional_process.sand_harness import reference_run  # noqa: E402
