"""Block-by-block comparison: does `functional_process.cottax.mda`'s driven graph reproduce
...
- `compare(graph, data)` seeds `functional_process.cottax.mda`'s `Schedule` for `graph` from
