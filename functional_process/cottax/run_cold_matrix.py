...
from functional_process.cottax.run_mdf_harness import MAX_ITER as MDF_MAX_ITER  # noqa: E402
from functional_process.cottax.run_mdf_harness import TOLERANCE as MDF_TOLERANCE  # noqa: E402
from functional_process.cottax.run_sand_harness import (  # noqa: E402
    SAND_MAX_ITER,
    _inputs_only,
    _seed,
    _why_no_step,
...
def provenance(mode=PROVIDER, argv=(), compare=None) -> list[str]:
    ...
    lines = [
        "# Generated by `$PY functional_process/cottax/run_cold_matrix.py"
