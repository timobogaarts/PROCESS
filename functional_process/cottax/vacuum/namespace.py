...
from functional_process.cottax.vacuum.vacuum import DuctDiameterRootFind, VacuumOld
...
class Vacuum(ModelNamespace):
    ...
    # `ConditionNode`, not a `NodalDeclaration` -- see its docstring for why it cannot be
