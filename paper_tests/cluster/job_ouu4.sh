...
#
# Third two-stage sweep (see job_ouu2.sh / job_ouu3.sh):
...
TAGS=(_D _D _D _D16   _B2 _B2 _B2 _B2_start)
ARGS=(
  "--pairing one --table build --objective levelised --te-recourse 5 --te-range 5,15 --chunk 2 --n 8192"
  "--pairing one --table build --objective levelised --te-recourse 5 --te-range 5,15 --chunk 2 --n 8192"
  "--pairing one --table build --objective levelised --te-recourse 5 --te-range 5,15 --chunk 2 --n 8192"
  "--pairing one --table build --objective levelised --te-recourse 5 --te-range 5,15 --chunk 2 --n 8192 --with-c16 --alpha16 0.5"
  "" "" "" ""
)
