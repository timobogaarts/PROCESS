...
Follows `test_build.py`/`test_stellarator_D_structure.py`'s shape: no test functions
...
`stellarator_C_geometry.py`'s module docstring). To exercise `st_new_config` itself
...
class TestDefaultAspectRatio(Tier1Contract):
    ...
    audit_record = "models/stellarator/stellarator_C_geometry.md"
