"""Harness cases for `functional_process/models/power_C_electric_production.py`.

Audit record: `functional_process/_audit/units/models/power_C_electric_production.md`. Legacy
points exist in `tests/unit/models/test_power.py` for `acpow`
...
this port (see `power_C_electric_production.md`).
"""
...
class TestAcpow(Tier1Contract):
    audit_record = "models/power_C_electric_production.md"
